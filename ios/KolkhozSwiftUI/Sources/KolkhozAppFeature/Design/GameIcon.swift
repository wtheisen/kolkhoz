...
enum GameIconAsset: String {
    ...
    case tutorial = "icon-tutorial"
    case tutorialCueTap = "icon-tutorial-cue-tap"
    case tutorialCueCard = "icon-tutorial-cue-card"
    case tutorialCueButton = "icon-tutorial-cue-button"
    case tutorialCueInspect = "icon-tutorial-cue-inspect"
    case tutorialCueDone = "icon-tutorial-cue-done"
