                ...
                for (final year in years)
                  _LogExpansion(
                    ...
                    title: language == KolkhozLanguage.en
                        ...
                        : 'Год ${year.year}',
                    iconAsset:
                        'ios_resources/Icons/icon-year-${year.year.clamp(1, 5)}.png',
                ...
                child: Tooltip(
                  ...
                  child: IconButton(
                    ...
                    onPressed: enabled
                        ...
                        : null,
                    icon: Image.asset(
                      'ios_resources/Icons/${reactionAsset(reactionID)}',
                      width: 30,
                      height: 30,
...
class _InlineSuitIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Tooltip(
      ...
      child: Image.asset(
        'ios_resources/Icons/icon-$resolvedSuit.png',
        width: 18,
        height: 18,
        filterQuality: FilterQuality.none,
...
String _phaseIconAsset(String phase) {
  ...
  return 'ios_resources/Icons/$icon';
}
