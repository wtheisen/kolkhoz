...
stop_stale_processes() {
  ...
  pkill -f "kolkhoz/clients/flutter_app.*flutter_tools.snapshot run -d macos" 2>/dev/null || true
  pkill -f "kolkhoz/clients/flutter_app.*flutter_tools.snapshot build macos" 2>/dev/null || true
  pkill -f "kolkhoz/clients/flutter_app.*Runner.xcworkspace" 2>/dev/null || true
