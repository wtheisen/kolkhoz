...
class LocalGameSession {
  LocalGameSession({
    ...
    List<EngineAction> gameLog = const [],
       ...
       _channel = LocalGameChannel(engine) {
    _listen();
  }
  ...
  GameEngine get engine => _channel.engine;
  ...
  void undoLastAction() {
    ...
    _replaceChannel(LocalGameChannel(snapshot.engine));
  ...
  void _runAutomaticStep() {
    ...
    if (command != null) {
      unawaited(_channel.send(command));
    }
  }
  ...
  void _replaceChannel(LocalGameChannel channel) {
