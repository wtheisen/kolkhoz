...
ROUTES: tuple[Route, ...] = (
    ...
    Route("GET", "/commerce/entitlements", "commerce.entitlements"),
    Route("POST", "/commerce/purchases/claim", "commerce.purchases.claim"),
    Route(
        "POST",
    ...
    Route("GET", "/profile", "profiles.get_current"),
    Route("PATCH", "/profile", "profiles.update_current"),
    ...
    Route("GET", "/tournaments/weekly", "tournaments.weekly.status"),
    Route("POST", "/tournaments/weekly/join", "tournaments.weekly.join"),
    Route("POST", "/tournaments/weekly/leave", "tournaments.weekly.leave"),
